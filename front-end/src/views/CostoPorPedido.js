  ...
  return (
    <>
      ...
      <Row className='match-height'>
        ...
        <Col sm='12'>
          <ColumnasBasicas titulo='Prueba' subtitulo='actualizado al 6/diciembre/2022' seccion={seccion} formato='moneda' mes={mes} anio={anio} region={region} zona={zona} tienda={tienda} metodoEnvio={metodoEnvio} />
        </Col>
      </Row>
    </>
  )
