    ...
    async def Temporada(self):
        ...
        if self.titulo == 'Pedidos Levantados Hoy':
            ...
            yAxis = [
                ...
                {'formato': 'moneda', 'titulo': 'Pesos', 'color': 'primary', 'opposite': True}
            ]
            series = [
                ...
                {'name': 'Ticket Promedio', 'data':[348.18, 365.62, 515.61, 563.31, 456.64, 535.17, 545.61, 594.79, 637.79, 716.98], 'type': 'spline', 'yAxis': 1, 'formato_tooltip':'moneda', 'color':'secondary'},
            ]
            categories = [
                '03:00',
                '04:00',
