...
async def venta_sin_impuestos (filtros: Filtro, seccion: str):
    ...
    if filtros.region != '' and filtros.region != "False" and filtros.region != None:
        ...
        if filtros.zona != '' and filtros.zona != "False" and filtros.zona != None:
            nombre_lugar = 'tiendaNombre'
            if filtros.tienda != '' and filtros.tienda != "False" and filtros.tienda != None:
                nivel_lugar = 'tienda'
                lugar = int(filtros.tienda)
            else:
                nivel_lugar = 'zona'
            ...
            nombre_lugar = 'zonaNombre'
    else:
        filtro_lugar = False
        nombre_lugar = 'regionNombre'
